...
exports.getRules = (req, res, next) => {
  ...
  if (!errors.isEmpty()) {
    ...
    res.status(200).json({
        ...
        data: {
          rule: `${req.body.rule_number}. ${rulesOfAcquisition[req.body.rule_number]}`
        }
    })
  }
};
...
const rulesOfAcquisition = {
  ...
  "84":"They can touch your ears but never your Latinum",
  ...
  "184":"There are three things you must not talk about with aliens: sex, religion and taxes",
  ...
  "268":"A) When in doubt, lie. B) When in doubt, buy. C) When in doubt, demand more money. D) When in doubt, shoot them, take their money, run and blame someone else",
